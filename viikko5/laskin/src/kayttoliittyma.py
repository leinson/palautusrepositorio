...
class Kumoa:
    def __init__(self, sovellus, etsi_edellinen):
        self.sovellus = sovellus
        self.etsi_edellinen = etsi_edellinen

    def suorita(self):
        self.etsi_edellinen().kumoa()
...
class Kayttoliittyma:
    def __init__(self, sovellus, root):
        ...
        self._komennot = {
            ...
            Komento.KUMOA: Kumoa(sovellus, self.etsi_edellinen)
        }
